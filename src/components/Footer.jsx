...
export default function Footer() {
  return (
    <footer className="mt-20 border-t border-gray-200 bg-white">
      <div className={`${BRAND.spacing.container} py-16`}>
        <div className={`grid gap-8 md:grid-cols-4 ${BRAND.spacing.gap}`}>
          {/* Brand */}
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/category/new-arrivals" className="text-gray-600 hover:text-pink-600 transition-colors">
                  New Arrivals
                </Link>
              </li>
              <li>
                <Link to="/category/clearance" className="text-gray-600 hover:text-pink-600 transition-colors">
                  Clearance
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <form className="space-y-2">
              ...
              <button
                type="submit"
                className="w-full px-4 py-2 bg-pink-500 text-white text-sm font-medium rounded-lg hover:bg-pink-600 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pink-500 focus-visible:ring-offset-2"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex space-x-6 text-sm text-gray-600">
              ...
              <a href="#" className="hover:text-pink-600 transition-colors">Shipping Policy</a>
            </div>
          </div>
        </div>
      </div>
